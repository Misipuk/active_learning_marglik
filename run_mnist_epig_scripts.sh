...
python3 run_image_classification_epig_40k.py --seed 4 --config configs/mnist_epig.yaml --device 'cpu'
...
python3 run_image_classification_epig_40k.py --seed 10 --config configs/mnist_epig.yaml --device 'cpu'