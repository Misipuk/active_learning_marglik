...
python3 run_image_classification_epig_40k.py --seed 6 --random_acquisition --config configs/mnist_epig.yaml --device 'cpu'
python3 run_image_classification_epig_40k.py --seed 7 --random_acquisition --config configs/mnist_epig.yaml --device 'cpu'
python3 run_image_classification_epig_40k.py --seed 8 --random_acquisition --config configs/mnist_epig.yaml --device 'cpu'
